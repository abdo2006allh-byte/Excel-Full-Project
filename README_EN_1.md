...
## 📌 Note on Publishing
This file contains real customer data (names, addresses, prices). **It is strongly recommended to anonymize or remove sensitive data (customer names, detailed addresses) before uploading to a public repository**, or keep the repository private, or publish only a sample/anonymized version for demonstration purposes.
